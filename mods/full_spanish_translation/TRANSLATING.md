...
English lives next door, in `full_spanish_translation-worksheet/`, one tab-separated file per
catalog:
...
return {
  full_spanish_translation = {
    image = "assets/font/full_spanish_translation.png",
...
```sh
python3 tools/modkit.py validate full_spanish_translation --base imported
python3 tools/modkit.py translation full_spanish_translation --refresh   # pick up new engine strings
